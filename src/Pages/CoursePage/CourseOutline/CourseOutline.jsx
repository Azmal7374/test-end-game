  ...
  return (
    <div className="p-4 rounded-lg">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <h2 className="text-xl w-full md:w-3/5 mb-3 mt-3 font-bold">Course Outline</h2>
      ...
      <ul className="border border-gray-300 rounded-md p-5 mt-5">
        {filteredMilestones.map((milestone, milestoneIndex) => (
          ...
          <span
          className={`cursor-pointer p-82 rounded-md text-white  ${
            ...
            {expandedMilestone === milestoneIndex && (
              <ul className="text-black mt-3 w-full bg-white">
                {milestone.modules.map((module, moduleIndex) => (
                  <li className="px-3  py-2  md:text-xl border-b border-green-400 mt-4 mb-4" key={moduleIndex}>
                  <span
